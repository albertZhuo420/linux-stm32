...
In the kernel source directory (sources/*/linux-stm32mp-6.1.28-stm32mp-r1-r0),
...
---------------------------------------------------------
    ...
    Branch: v6.1-stm32mp
    Revision: v6.1-stm32mp-r1

    $ git clone https://github.com/STMicroelectronics/linux.git
    $ git checkout -b WORKING v6.1-stm32mp-r1
...
---------------------------------------------------------------
    ...
    $ cd linux-stable
    $ git checkout -b WORKING v6.1.28
